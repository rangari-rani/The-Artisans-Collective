...
import com.art.repository.PaymentOrderRepository;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public String createStripePaymentLink(User user, Long amount, Long orderId) throws StripeException {
        ...
        SessionCreateParams params = SessionCreateParams.builder().addPaymentMethodType(SessionCreateParams.PaymentMethodType.CARD).setMode(SessionCreateParams.Mode.PAYMENT).setSuccessUrl("http://localhost:3000/payment-success/" + orderId).
                ...
                .addLineItem(SessionCreateParams.LineItem.builder()
                        ...
                        .setPriceData(SessionCreateParams.LineItem.PriceData.builder().setCurrency("usd")
                                .setUnitAmount(amount * 100).setProductData(
                                        SessionCreateParams.LineItem.PriceData.ProductData.builder().setName("The Artisans Collective payment").build()
                                ).build()
                        ).build()
                ).build();
